export const business = {
  name: 'Shocka Pools',
  domain: 'shockapools.com',
  owner: 'Isiah Caban',
  phoneDisplay: '(808) 333-0615',
...
export const services = [
  {
    slug: 'pool-service',
    title: 'Pool Service',
    summary: 'Routine pool care to keep water clean, balanced, and ready to enjoy.',
    details: 'Shocka Pools provides dependable pool service for East Hawaii homeowners who want clean water, consistent upkeep, and service that feels easy to work with. Regular cleaning, water balancing, and routine checks all help protect the look and performance of your pool.',
...
export const seoTowns = {
  hilo: {
    name: 'Hilo',
    title: 'Pool, Catchment Tank, and Rain Gutter Service in Hilo, Hawaii',
    description: 'Shocka Pools provides local pool service, catchment tank service, and rain gutter service for homeowners in Hilo on the east side of the Big Island.'
  },
  pahoa: {
    name: 'Pahoa',
    title: 'Pool, Catchment Tank, and Rain Gutter Service in Pahoa, Hawaii',
    description: 'Shocka Pools serves Pahoa homeowners with dependable pool service, catchment tank service, and rain gutter cleaning on the east side of Hawaii Island.'
  },
  keaau: {
    name: 'Keaau',
  ...
  'mountain-view': {
    name: 'Mountain View',
    title: 'Pool, Catchment Tank, and Rain Gutter Service in Mountain View, Hawaii',
    description: 'Shocka Pools helps Mountain View homeowners maintain pools, catchment systems, and gutters with reliable East Hawaii service.'
  },
  kurtistown: {
    name: 'Kurtistown',
    title: 'Pool, Catchment Tank, and Rain Gutter Service in Kurtistown, Hawaii',
    description: 'Shocka Pools provides East Hawaii homeowners in Kurtistown with practical pool, catchment tank, and rain gutter service.'
  },
  volcano: {
    name: 'Volcano',
    title: 'Pool, Catchment Tank, and Rain Gutter Service in Volcano, Hawaii',
    description: 'Shocka Pools serves Volcano with local pool service, catchment tank care, and rain gutter cleaning for East Hawaii properties.'
  }
};
